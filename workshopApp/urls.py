...
urlpatterns=[
 ...
 #admin
    ...
    path('approve_payment/<int:id>/', admin_view.approve_payment, name='approve_payment'),
...
#worker
   ...
   path('feedbak_register', worker_view.feedbak_register, name='feedbak_register'),
   path('feedback_view', worker_view.feedback_view, name='feedback_view'),
